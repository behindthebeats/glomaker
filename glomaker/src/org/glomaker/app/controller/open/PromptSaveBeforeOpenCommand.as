...
package org.glomaker.app.controller.open
{
	...
	/**
	 * Prompts the user to save data before opening a new document.
	 * You should call the 'SetOpenPendingCommand' before executing this one.
	 * @see org.glomaker.app.controller.open.FileOpenMacroCommand 
	 * @author Nils
	 */
	public class PromptSaveBeforeOpenCommand extends BaseCommand
	{
		...
		override public function execute(notification:INotification):void
		{
			...
			med.noNotification = Notifications.OPENFILE_SHOWSELECTOR;
