...
package org.glomaker.app.view.components
{
	 ...
	 * @author Nils
	 */
	public class SimpleToggleTileList extends TileList
	{
		
		/**
		 * Constructor 
		 */		
		public function SimpleToggleTileList()
		{
		...
		override protected function selectItem(item:IListItemRenderer, shiftKey:Boolean, ctrlKey:Boolean, transition:Boolean=true):Boolean
		{
			...
			// similarly, if the currently selected item was clicked again, we simply deselect it
			if(!item)
			{
				clearSelected();
				return false;
			...
			// if the item is already selected, simply ignore the request
